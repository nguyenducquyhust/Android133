package com.lab.kiotmpecbk.activity.trangchu.ui.hanghoa.banhang;
...
public class HangHoaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_hanghoa);
...
//        AHBottomNavigation bottomNavigation = (AHBottomNavigation) findViewById(R.id.bottom_navigation);
    ...
    public void setCountProductInCart (int count){
        ...
        AHNotification notification = new AHNotification.Builder()
                ...
                .setBackgroundColor(ContextCompat.getColor(HangHoaActivity.this, R.color.red))
                .setTextColor(ContextCompat.getColor(HangHoaActivity.this, R.color.white))
                .build();
